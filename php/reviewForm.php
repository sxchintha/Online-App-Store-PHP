  ...
  <div class="Rcard">
    <div class="card-details">
      <form action="./actions/addReview.php" method="POST">
        ...
        <input type="text" id="name" name="name" placeholder="Name :" class="rating-input" readonly value="<?php echo $_SESSION['fname'] . ' ' . $_SESSION['lname'] ?>" />

        <br /><br />
        <input type="text" id="email" name="email" placeholder="Email :" class="rating-input" readonly value="<?php echo $_SESSION['email'] ?>" />

        <br /><br />
        <input type="text" id="subject" name="subject" placeholder="Subject :" class="rating-input" />

        <br /><br />

        <select name="country" id="country" class="rating-input" required>
        ...
        <select name="rating" id="rating" class="rating-input" required>
        ...
        <br /><br />
        <textarea class="review-textA" name="comment" id="comment" cols="30" rows="10" placeholder="Comments :"></textarea>
        <br /><br />
        <div class="center">
